...
public class Parser_JavaTest
{
	...
	private List<Token> makeGenericTokenList()
	{
		...
		result.add(new Token(TokenType._PACKAGE, 0, 0));
		result.add(new Token(TokenType.IDENTIFIER, 0, 0, "com"));
		result.add(new Token(TokenType.DOT, 0, 0));
		result.add(new Token(TokenType.IDENTIFIER, 0, 0, "test"));
		result.add(new Token(TokenType.SEMICOLON, 0, 0));

		result.add(new Token(TokenType._IMPORT, 0, 0));
		result.add(new Token(TokenType.IDENTIFIER, 0, 0, "java"));
		result.add(new Token(TokenType.DOT, 0, 0));
		result.add(new Token(TokenType.IDENTIFIER, 0, 0, "util"));
		result.add(new Token(TokenType.SEMICOLON, 0, 0));
		...
		result.add(new Token(TokenType.IDENTIFIER, 0, 0, "java"));
		result.add(new Token(TokenType.DOT, 0, 0));
		result.add(new Token(TokenType.IDENTIFIER, 0, 0, "lang"));
		result.add(new Token(TokenType.SEMICOLON, 0, 0));

		result.add(new Token(TokenType._IMPORT, 0, 0));
		result.add(new Token(TokenType.IDENTIFIER, 0, 0, "java"));
		result.add(new Token(TokenType.DOT, 0, 0));
		result.add(new Token(TokenType.IDENTIFIER, 0, 0, "swing"));
		result.add(new Token(TokenType.DOT, 0, 0));
		result.add(new Token(TokenType.STAR, 0, 0));
		result.add(new Token(TokenType.SEMICOLON, 0, 0));
		...
		result.add(new Token(TokenType._PUBLIC, 0, 0));
		result.add(new Token(TokenType._STATIC, 0, 0));
		result.add(new Token(TokenType.IDENTIFIER, 0, 0, "int"));
		result.add(new Token(TokenType.IDENTIFIER, 0, 0, "var1"));
