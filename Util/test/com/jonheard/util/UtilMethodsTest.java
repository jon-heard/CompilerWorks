...
public class UtilMethodsTest {
  ...
  public void fileToByteArray() {
    ...
    /// Run tests
    byte[] actual1 = UtilMethods.fileToByteArray(TEST_DIR + "/" + TEST_FILENAME_1);
    byte[] actual2 = UtilMethods.fileToByteArray(TEST_DIR + "/" + TEST_FILENAME_2);
  ...
  public void tokenizeStringTest() {
    ...
    String in5 = " \tfirst \nsecond\t\nthird \t\n";
    String in6 = " \t \t first \n \nsecond\t\n\t\nthird \t\n \t\n";
    List<String> expected3 = Arrays.asList("first", "second third", "fourth");
    ...
    assertEquals(expected2, UtilMethods.tokenizeStringByWhitespace(in3));
    assertEquals(expected2, UtilMethods.tokenizeStringByWhitespace(in4));
    assertEquals(expected2, UtilMethods.tokenizeStringByWhitespace(in5));
    assertEquals(expected2, UtilMethods.tokenizeStringByWhitespace(in6));
    assertEquals(expected3, UtilMethods.tokenizeStringByWhitespace(in7));
    assertEquals(expected4, UtilMethods.tokenizeStringByWhitespace(in8));
  }
  ...
  public void enumContainsStringTest() {
    ...
    assertFalse(UtilMethods.enumHasValue(EnumTest1.class, "fourth"));
    assertFalse(UtilMethods.enumHasValue(EnumTest1.class, "FIRST"));
  }

  @Test
  public void constNameToCamelNameTest() {
    assertEquals("oneTwoThree", UtilMethods.constNameToCamelName("ONE_TWO_THREE", false));
    assertEquals("OneTwoThree", UtilMethods.constNameToCamelName("ONE_TWO_THREE", true));
    assertEquals("oneTwo_Three", UtilMethods.constNameToCamelName("ONE_TWO__THREE", false));
    assertEquals("OneTwoThree", UtilMethods.constNameToCamelName("_ONE_TWO_THREE", false));
    assertEquals("OneTwoThree", UtilMethods.constNameToCamelName("_ONE_TWO_THREE", true));
    assertEquals("1neTwoThree", UtilMethods.constNameToCamelName("1ne_TWO_THREE", false));
    assertEquals("1neTwoThree", UtilMethods.constNameToCamelName("1ne_TWO_THREE", true));
    assertEquals("1neTwoThree", UtilMethods.constNameToCamelName("_1ne_TWO_THREE", false));
    assertEquals("1neTwoThree", UtilMethods.constNameToCamelName("_1ne_TWO_THREE", true));
    assertEquals("oneTwo3hree", UtilMethods.constNameToCamelName("ONE_TWO_3HREE", false));
    assertEquals("OneTwo3hree", UtilMethods.constNameToCamelName("ONE_TWO_3HREE", true));
    assertEquals("oneTwo_3hree", UtilMethods.constNameToCamelName("ONE_TWO__3HREE", false));
    assertEquals("OneTwo_3hree", UtilMethods.constNameToCamelName("ONE_TWO__3HREE", true));
  }
  ...
  public void buildMethodDescriptorTest() {
    ...
    expected = "(BI)Z";
    actual = UtilMethods.buildMethodDescriptor("Z", Arrays.asList("B", "I"));
    assertEquals(expected, actual);

    expected = "(BLjava/lang/String;I)Z";
    actual = UtilMethods.buildMethodDescriptor("Z", Arrays.asList("B", "Ljava/lang/String;", "I"));
    assertEquals(expected, actual);
  ...
  public void getStackSizefMethodDescriptorTest() {
    ...
    expected = 3;
    actual = UtilMethods.getStackSizeOfMethodDescriptor("([JLjava/lang/String;[D)B");
    assertEquals(expected, actual);

    expected = 3;
    actual = UtilMethods.getStackSizeOfMethodDescriptor("([J[Ljava/lang/String;[D)B");
    assertEquals(expected, actual);
  }
  ...
  public void getStackSizefFieldDescriptorTest() {
    ...
    expected = 1;
    actual = UtilMethods.getStackSizeOfFieldDescriptor("Ljava/lang/String");
    assertEquals(expected, actual);
  ...
  public void generateFlagsFromModifierListTest() {
    ...
    expected = 0x0001;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("public"));
    assertEquals(expected, actual);

    expected = 0x0002;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("private"));
    assertEquals(expected, actual);

    expected = 0x0004;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("protected"));
    assertEquals(expected, actual);

    expected = 0x0008;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("static"));
    assertEquals(expected, actual);

    expected = 0x0010;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("final"));
    assertEquals(expected, actual);

    expected = 0x0020;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("synchronized"));
    assertEquals(expected, actual);

    expected = 0x0020;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("super"));
    assertEquals(expected, actual);

    expected = 0x0040;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("bridge"));
    assertEquals(expected, actual);

    expected = 0x0040;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("volatile"));
    assertEquals(expected, actual);

    expected = 0x0080;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("varargs"));
    assertEquals(expected, actual);

    expected = 0x0080;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("transient"));
    assertEquals(expected, actual);

    expected = 0x0100;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("native"));
    assertEquals(expected, actual);

    expected = 0x0200;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("interface"));
    assertEquals(expected, actual);

    expected = 0x00400;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("abstract"));
    assertEquals(expected, actual);

    expected = 0x0800;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("strict"));
    assertEquals(expected, actual);

    expected = 0x1000;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("synthetic"));
    assertEquals(expected, actual);

    expected = 0x2000;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("annotation"));
    assertEquals(expected, actual);

    expected = 0x4000;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("enum"));
    assertEquals(expected, actual);

    expected = 0x0001 | 0x0002;
    actual = UtilMethods.generateFlagsFromModifierList(Arrays.asList("public", "private"));
    assertEquals(expected, actual);
  }
}
