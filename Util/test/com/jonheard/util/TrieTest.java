...
public class TrieTest {
  ...
  @Test
  public void getLongestMatchFromEmbeddedKey() {
    Trie<String> t = new Trie<String>();
    t.put("super", "super");
    t.put("superman", "superman");

    assertEquals("superman", t.getFromEmbeddedKey("hero superman saves the day", 5));
  }
  ...
  public void generics() {
    ...
    assertEquals(new Integer(3), t.getFromEmbeddedKey("one two three four", 8));
